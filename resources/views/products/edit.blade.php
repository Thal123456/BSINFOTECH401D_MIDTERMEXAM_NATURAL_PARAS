...
<body class="min-h-screen bg-primary flex items-center justify-center">
    <div class="w-full flex flex-col items-center">
        <div class="bg-card p-6 rounded-lg shadow-lg max-w-md w-full">
            <h2 class="text-2xl font-bold text-foreground mb-4 text-center">EDIT PRODUCT</h2>
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="border border-muted rounded-lg p-2 w-full h-18 overflow-y-auto scrollbar-none"
                ...
                <div class="mb-4">
                    @if($product->image)
                        <div class="flex flex-col items-center">
                            <p class="text-center mb-2 text-xs">{{ $product->image }}</p>
                ...
                <div>
                    <button type="submit"
                        class="bg-primary text-primary-foreground hover:bg-primary/80 w-full p-2 rounded-lg">Update</button>
                </div>
            </form>
